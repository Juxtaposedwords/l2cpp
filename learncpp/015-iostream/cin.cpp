...
int main()
{
    ...
    // Note: cin is using space delimiters. It is possible to change this delimiter
    // https://stackoverflow.com/questions/7302996/changing-the-delimiter-for-cin-c
    std::cin >> x >> y; // you get two numbers and store the variables in x and y respectively.
